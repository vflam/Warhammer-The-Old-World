...
<gameSystem xmlns="http://www.battlescribe.net/schema/gameSystemSchema" id="sys-31d1-bf57-53ea-ad55" name="Warhammer The Old World" battleScribeVersion="2.03" revision="70" type="gameSystem" library="true" authorName="Flammy" authorContact="Discord: vflam" authorUrl="www.newrecruit.eu" publicationId="768b-3da1-a182-a1d8">
  <categoryEntries>
...
If the only other remaining models in a unit are the champion and standard bearer, the musician must be removed as a casualty before either.</characteristic>
    ...
    <profile name="Hand Weapon" typeId="a378-c633-912d-11ce" typeName="Weapon" hidden="false" id="6d4a-7733-d725-a267">
      <characteristics>
        ...
        <characteristic name="Notes" typeId="772a-a7ff-f6b3-df71">Unless specified otherwise, all models are assumed to be equipped with a hand
