...
<gameSystem xmlns="http://www.battlescribe.net/schema/gameSystemSchema" id="sys-31d1-bf57-53ea-ad55" name="Warhammer The Old World" battleScribeVersion="2.03" revision="55" type="gameSystem" library="true" authorName="Flammy" authorContact="Discord: vflam" authorUrl="www.newrecruit.eu" publicationId="768b-3da1-a182-a1d8">
  <categoryEntries>
...
Notes: Unless specified otherwise, all models are assumed to be equipped with a hand weapon.	Special Rules: -</characteristic>
      </characteristics>
    </profile>
...
Notes: Cannon (of any type) do not use their crew’s Ballistic Skill. Instead, they shoot using the ‘Cannon Fire’ special rule. This weapon uses the Black Powder Misfire table.	Special Rules: Armour Bane (2), Cannon Fire, Cumbersome, Move or Shoot, Multiple Wounds (D3)</characteristic>
      </characteristics>
    </profile>
...
Notes: Models whose troop type is ‘cavalry’, ‘monster’ or ‘chariot’ only. A cavalry spear’s Strength and Armour Piercing modifiers apply only during a turn in which the wielder charged. A model wielding a cavalry spear cannot make a supporting attack during a turn in which it charged.	Special Rules: Fight in Extra Rank</characteristic>
    ...
    <profile name="Morning star" hidden="false" id="caad-2fc0-e82a-18fd" typeId="cc88-6a7d-41c9-d63e" typeName="Weapon" page="214" publicationId="768b-3da1-a182-a1d8">
      <characteristics>
        <characteristic name="Description" typeId="47f2-ecee-cae0-9ef9">R: Combat	S: S+1	AP: -1	
Notes: A morning star’s Strength modifier applies only during the first round of combat.	Special Rules: -</characteristic>
      </characteristics>
    </profile>
...
Notes: A flail’s Strength modifier applies only during the first round of combat.	Special Rules: Requires Two Hands</characteristic>
      </characteristics>
    </profile>
    ...
    <profile name="Lance" hidden="false" id="3520-64c9-a855-ce9e" typeId="cc88-6a7d-41c9-d63e" typeName="Weapon" page="215" publicationId="768b-3da1-a182-a1d8">
      <characteristics>
        <characteristic name="Description" typeId="47f2-ecee-cae0-9ef9">R: Combat	S: S+2	AP: -2	
Notes: Models whose troop type is ‘cavalry’ or ‘monster’ only. A lance can only be used during a turn in which the wielder charged. In subsequent turns (or if the wielder did not charge) the model must use its hand weapon instead.	Special Rules: Armour Bane (1)</characteristic>
      </characteristics>
    </profile>
